...
fn decode_r_type(opcode: u32, inst: u32) -> Instruction {
...
fn decode_r4_type(opcode: u32, inst: u32) -> Instruction {
    let rd = (inst & masks::RD_MASK) >> 7;
    let funct3 = (inst & masks::FUNCT3_MASK) >> 12;
    let rs1 = (inst & masks::RS1_MASK) >> 15;
    let rs2 = (inst & masks::RS2_MASK) >> 20;
...
fn decode_i_type(opcode: u32, inst: u32) -> Instruction {
    let rd = (inst & masks::RD_MASK) >> 7;
    let funct3 = (inst & masks::FUNCT3_MASK) >> 12;
    let rs1 = (inst & masks::RS1_MASK) >> 15;
...
fn decode_s_type(opcode: u32, inst: u32) -> Instruction {
...
fn decode_b_type(opcode: u32, inst: u32) -> Instruction {
...
fn decode_u_type(opcode: u32, inst: u32) -> Instruction {
    let rd = (inst & masks::RD_MASK) >> 7;
...
fn decode_j_type(opcode: u32, inst: u32) -> Instruction {
    let rd = (inst & masks::RD_MASK) >> 7;
