...
// isa_test!(rv64ui_p_fence_i, "rv64ui-p-fence_i", { 16 * KB });
...
// isa_test!(rv64ui_p_ma_data, "rv64ui-p-ma_data", { 16 * KB });
...
isa_test!(rv64si_p_csr, { 16 * KB });
isa_test!(rv64si_p_scall, { 16 * KB });
